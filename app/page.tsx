        ...
        <div className="container">
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "20px" }}>
            <Reveal direction="left" delay={100}>
              <Link href="/rental-mobil" className="layanan-card" style={{ display: "flex", flexDirection: "column", height: "100%" }}>
            ...
            <Reveal direction="right" delay={200}>
              <Link href="/paket-wisata" className="layanan-card" style={{ display: "flex", flexDirection: "column", height: "100%" }}>
                <div className="layanan-img">
        ...
        <div className="container">
          <Reveal direction="scale" delay={100}>
            <div className="cta-box">
              ...
              <a href="https://wa.me/6285143010008?text=Halo%20KDS%20Trans%2C%20saya%20ingin%20memesan%20layanan" target="_blank" rel="noopener noreferrer" className="btn-wa-large">
