    ...
    <main style={{ backgroundColor: "#fff", minHeight: "100vh" }}>
          ...
          {[
            ...
            <div key={i} style={carCardStyle}>
              ...
              <div style={carBody}>
                ...
                <a
                  href={`https://wa.me/6285143010008?text=${encodeURIComponent(`Halo KDS Trans, saya ingin menyewa ${car.name}. Mohon info ketersediaan.`)}`}
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(340px, 1fr))", gap: "20px" }}>
          {[
            ...
            <div key={i} className="flex-mobile-column" style={premiumCard}>
              {/* wrapper putih — background konsisten untuk semua foto termasuk Pajero */}
              ...
              <div style={{ flex: 1 }}>
                ...
                <a
                  href={`https://wa.me/6285143010008?text=${encodeURIComponent(`Halo KDS Trans, saya ingin info armada ${car.name}.`)}`}
                  target="_blank" rel="noopener noreferrer"
                  style={{ color: "var(--green-wa)", fontWeight: "700", textDecoration: "none", fontSize: "0.85rem" }}
                >
                  💬 Pesan via WA
                </a>
              </div>
      ...
      <section style={{ padding: "0 24px 80px" }}>
        <div className="cta-box" style={{ maxWidth: "1000px", margin: "0 auto" }}>
          ...
          <a
            href="https://wa.me/6285143010008?text=Halo%20KDS%20Trans%2C%20saya%20butuh%20rekomendasi%20armada."
            target="_blank" rel="noopener noreferrer"
...
/* ─── STYLES ─── */
const carCardStyle:     CSSProperties = { backgroundColor: "#fff", borderRadius: "16px", border: "1px solid var(--border)", overflow: "hidden", display: "flex", flexDirection: "column", boxShadow: "var(--shadow-sm)", transition: "0.2s" };
...
const typeBadge:        CSSProperties = { position: "absolute", top: "12px", left: "12px", backgroundColor: "rgba(255,255,255,0.92)", padding: "4px 10px", borderRadius: "50px", fontSize: "0.7rem", fontWeight: "800", border: "1px solid #eee", backdropFilter: "blur(4px)" };
...
const btnSewa:          CSSProperties = { marginTop: "auto", backgroundColor: "var(--green-wa)", color: "#fff", textAlign: "center", padding: "12px", borderRadius: "10px", fontWeight: "800", textDecoration: "none", fontSize: "0.9rem", display: "block", transition: "0.2s" };
...
// wrapper putih dengan ukuran fixed — foto di dalam lebih besar, bg selalu putih
